...
public enum Direction {
    ...
    public static String toString(int clientValue) {
        return Arrays.stream(values()).filter(d -> d.clientValue == clientValue).findFirst().get().name();
    }
